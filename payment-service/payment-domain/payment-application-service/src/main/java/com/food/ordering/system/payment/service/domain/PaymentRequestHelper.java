...
public class PaymentRequestHelper {
  ...
  public void persistPayment(PaymentRequest paymentRequest) {
    ...
    orderOutboxHelper.save(
        ...
        paymentEvent.value().getPaymentStatus(),
  ...
  public void persistCancelPayment(PaymentRequest paymentRequest) {
    ...
    if (paymentResponse.isEmpty()) {
      ...
      throw new PaymentNotFoundException("Payment with order id " + paymentRequest.getOrderId() + " could not be " +
                                             "found!");
    }
  ...
  private CreditEntry getCreditEntry(CustomerId customerId) {
    ...
    if (creditEntry.isEmpty()) {
      ...
      throw new PaymentNotFoundException("Could not find credit entry for customer: " + customerId.getValue());
    }
  ...
  private List<CreditHistory> getCreditHistory(CustomerId customerId) {
    ...
    if (creditHistories.isEmpty()) {
      ...
      throw new PaymentNotFoundException("Could not find credit history for customer: " + customerId.getValue());
    }
  ...
  private boolean publishIfOutboxMessageProcessedForPayment(PaymentRequest paymentRequest,
    ...
    if (outboxMessage.isPresent()) {
      paymentResponseMessagePublisher.publish(outboxMessage.get(), orderOutboxHelper::updateOutboxStatus);
      return true;
    }
    return false;
  }
