...
public class ApprovalOutboxHelper {
  ...
  public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
    OrderApprovalOutboxMessage outboxMessage = approvalOutboxRepository.save(orderApprovalOutboxMessage);
    ...
    log.info("OrderApprovalOutboxMessage saved with outbox id: {}", outboxMessage.getId());
  }
