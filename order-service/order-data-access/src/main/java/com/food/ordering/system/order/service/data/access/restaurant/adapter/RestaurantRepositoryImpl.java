...
public class RestaurantRepositoryImpl implements RestaurantRepository {
  ...
  public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
    Set<UUID> restaurantProductIds = restaurantDataAccessMapper.restaurantToRestaurantProducts(restaurant);
    Optional<Set<RestaurantEntity>> restaurantEntities = restaurantJpaRepository
